...
are overridden by settings in /etc/satcli/satcli.conf and/or
~/.satcli.conf (by default) and therefore, any default configurations
...
prefix = os.path.join(os.environ['HOME'], '.satcli')
